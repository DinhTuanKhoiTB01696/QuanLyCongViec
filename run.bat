...
if /I "%resetDB%"=="Y" (
    ...
    sqlcmd -S "localhost" -Q "IF DB_ID('TaskManagementDB') IS NOT NULL BEGIN ALTER DATABASE [TaskManagementDB] SET SINGLE_USER WITH ROLLBACK IMMEDIATE; DROP DATABASE [TaskManagementDB]; END" -E -C
    ...
    sqlcmd -S "localhost" -d "TaskManagementDB" -i "..\..\seed_data.sql" -E -C
