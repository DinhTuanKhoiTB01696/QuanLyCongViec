...
// Fetch the clean original file directly from Git without PowerShell redirection
const originalContent = execSync('git show HEAD:Frontend/src/components/TaskDetailModal.vue').toString('utf8');
