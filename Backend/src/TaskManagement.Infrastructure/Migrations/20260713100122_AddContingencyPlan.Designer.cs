...
namespace TaskManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260713100122_AddContingencyPlan")]
    partial class AddContingencyPlan
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.ContingencyPlan", b =>
                {
                    ...
                    b.Property<DateTime?>("FallbackDeadline")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.Project", b =>
                {
                    ...
                    b.Property<string>("TrackedLinkUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.ContingencyPlan", b =>
                {
                    b.HasOne("TaskManagement.Domain.Entities.User", "BackupOwner")
                        .WithMany()
                        .HasForeignKey("BackupOwnerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TaskManagement.Domain.Entities.WorkTask", "WorkTask")
                        .WithOne("ContingencyPlan")
                        .HasForeignKey("TaskManagement.Domain.Entities.ContingencyPlan", "WorkTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BackupOwner");
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.KudoReaction", b =>
                {
                    b.HasOne("TaskManagement.Domain.Entities.Kudo", "Kudo")
                        .WithMany()
