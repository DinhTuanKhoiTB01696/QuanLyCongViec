...
namespace TaskManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260622114152_PlaneRenovation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.GoalFollower", b =>
                {
                    b.Property<Guid>("GoalId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.GoalUpdateReaction", b =>
                {
                    ...
                    b.HasIndex("GoalUpdateId", "UserId")
                        .IsUnique();
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.ProjectFollower", b =>
                {
                    b.Property<Guid>("ProjectId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.ProjectUpdate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.ProjectUpdateAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProjectUpdateAttachments");
                });

            modelBuilder.Entity("TaskManagement.Domain.Entities.ProjectUpdateReaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ProjectUpdateId", "UserId")
                        .IsUnique();

                    b.ToTable("ProjectUpdateReactions");
                });
            ...
            modelBuilder.Entity("TaskManagement.Domain.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("TaskManagement.Domain.Entities.ProjectUpdate", "ProjectUpdate")
                        .WithMany("Comments")
