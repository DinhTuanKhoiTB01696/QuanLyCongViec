    ...
    public partial class PlaneRenovation : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GoalFollowers", x => new { x.GoalId, x.UserId });
                    table.ForeignKey(
                        name: "FK_GoalFollowers_Goals_GoalId",
                        column: x => x.GoalId,
                        principalTable: "Goals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GoalFollowers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectUpdateAttachments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectUpdateAttachments_ProjectUpdates_ProjectUpdateId",
                        column: x => x.ProjectUpdateId,
                        principalTable: "ProjectUpdates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectUpdateAttachments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectUpdateReactions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectUpdateReactions_ProjectUpdates_ProjectUpdateId",
                        column: x => x.ProjectUpdateId,
                        principalTable: "ProjectUpdates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectUpdateReactions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_ProjectUpdates_ProjectUpdateId",
                        column: x => x.ProjectUpdateId,
                        principalTable: "ProjectUpdates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comments_ProjectUpdateId",
                table: "Comments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GoalUpdateReactions_GoalUpdateId_UserId",
                table: "GoalUpdateReactions",
                columns: new[] { "GoalUpdateId", "UserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectUpdateAttachments_ProjectUpdateId",
                table: "ProjectUpdateAttachments",
                column: "ProjectUpdateId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectUpdateAttachments_UserId",
                table: "ProjectUpdateAttachments",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectUpdateReactions_ProjectUpdateId_UserId",
                table: "ProjectUpdateReactions",
                columns: new[] { "ProjectUpdateId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProjectUpdateReactions_UserId",
                table: "ProjectUpdateReactions",
                column: "UserId");
