...
## DEC-039 — Reported Pass không phải Verified Pass

- Trạng thái: `ACTIVE/FROZEN`
- File 1.000 dòng chỉ có 47 kịch bản gốc.
- File 600 dòng có 36 fail và 9 dòng malformed.
- Chỉ ghi Complete khi critical path có automated/E2E/database evidence.

## DEC-040 — P0 là release gate

- Trạng thái: `ACTIVE/FROZEN`
- Không ưu tiên feature nâng cao trước auth, permission, data integrity, hosting và AI safety.

## DEC-041 — AI Credits tách Gamification Points

- Trạng thái: `ACTIVE/FROZEN`
- Promotional, purchased AI Credits và Gamification Points dùng ledger/balance riêng.
- Không bán provider token trực tiếp cho user.

## DEC-042 — Payment qua gateway adapter

- Trạng thái: `ACTIVE`
- Làm VNPAY sandbox trước; MoMo/ZaloPay là adapter sau.
- Chỉ webhook/query đã verify mới cộng Credits.

## DEC-043 — ECharts là chart stack mục tiêu

- Trạng thái: `ACTIVE`
- Không thêm chart mới bằng Apex/Chart.js.
- Chỉ gỡ dependency cũ sau khi migrate và grep không còn import.
